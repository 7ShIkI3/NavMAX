...
class BattleManager:
    ...
    def _check_dependencies(
        ...
        for dep in phase.depends_on:
            ...
            if result is None:
                return False
            if result.status not in (PhaseStatus.COMPLETED, PhaseStatus.SKIPPED, PhaseStatus.FAILED):
                return False
