...
class MockProvider(BaseProvider):
    ...
    def __init__(self, models: list[ModelInfo] | None = None, healthy: bool = True) -> None:
...
def make_model(
    name: str, provider: ProviderType = ProviderType.OLLAMA, tier: ModelTier = ModelTier.MEDIUM,
) -> ModelInfo:
...
class TestHardwareProfile:
    ...
    def test_not_apple_silicon(self) -> None:
...
class TestModelSelector:
    ...
    @pytest.mark.asyncio
    async def test_scan_empty(self, hw_medium) -> None:
    ...
    @pytest.mark.asyncio
    async def test_scan_with_models(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
    ...
    @pytest.mark.asyncio
    async def test_scan_abliterated_preferred(self, hw_medium) -> None:
        ...
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
                    make_model("llama3.1:8b", ProviderType.OLLAMA, ModelTier.MEDIUM),
                    make_model(
                        "huihui_ai/llama3.1-abliterated:8b", ProviderType.OLLAMA, ModelTier.MEDIUM,
                    ),
                ],
            ),
        }
    ...
    @pytest.mark.asyncio
    async def test_select_prefer_uncensored(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium, prefer_uncensored=True)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
    ...
    @pytest.mark.asyncio
    async def test_select_no_uncensored_fallback(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
    ...
    @pytest.mark.asyncio
    async def test_select_heavy_fallback_to_medium(self, hw_medium) -> None:
    ...
    @pytest.mark.asyncio
    async def test_select_no_model_available(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium)
        providers = {
            ProviderType.OLLAMA: MockProvider(models=[], healthy=True),
        }
    ...
    @pytest.mark.asyncio
    async def test_select_force_model(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
    ...
    @pytest.mark.asyncio
    async def test_airgap_blocks_cloud(self, hw_medium) -> None:
    ...
    @pytest.mark.asyncio
    async def test_recommendations_when_no_abliterated(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium, prefer_uncensored=True)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
    ...
    @pytest.mark.asyncio
    async def test_get_status(self, hw_medium) -> None:
        selector = ModelSelector(hardware=hw_medium)
        providers = {
            ProviderType.OLLAMA: MockProvider(
                models=[
...
class TestSelectionResult:
    def test_display_name_local_uncensored(self) -> None:
    ...
    def test_display_name_cloud(self) -> None:
        result = SelectionResult(
            entry=None,
            model="gpt-4o",
