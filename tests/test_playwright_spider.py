...
class TestPlaywrightSpider:
    ...
    @pytest.mark.asyncio
    async def test_crawl_without_playwright_raises(self):
        spider = PlaywrightSpider()
...
class TestFallback:
    ...
    @pytest.mark.asyncio
    async def test_prefer_spa_flag_accepted(self):
